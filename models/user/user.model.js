...
const userSchema = new mongoose.Schema({
  ...
  level: { 
    ...
    default: 'New Farmer',
    enum: {
      values: ['New Farmer', 'Apprentice Farmer', 'Skilled Farmer', 'Experienced Farmer', 'Expert Farmer', 'Master Farmer', 'Agricultural Specialist', 'Farming Legend'],
...
userSchema.methods.isRecentlyActive = function() {
  const daysSinceActive = Math.floor((new Date() - this.lastActiveDate) / (1000 * 60 * 60 * 24));
